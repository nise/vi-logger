...
define([
    'jquery',
    'lib/vi2/vi2.core.player.timeline',
    'lib/spin'
], function (
    $,
    Timeline,
    Spinner
        ...
        Player.prototype = {
            ...
            loadVideo: function (url, seek) {
                ...
                this.video.addEventListener('playingXXX', function () { 
            ...
            **/
            endedHandler: function (e) {
                vi2.observer.log({ context: 'player', action: 'video-ended', values: [this.currentTime()] });
                vi2.observer.ended();
